var settings = {
    mqtt: {
        host: process.env.MQTT_HOST || 'mqtts://m21.cloudmqtt.com',
        port: process.env.MQTT_PORT || 28437,
        user: process.env.MQTT_USER || 'webclient',
        password: process.env.MQTT_PASS || 'webclientpwd',
        clientId: process.env.MQTT_CLIENT_ID || 'bridge'
    },
    keepalive: {
    ...
    http_port: process.env.PORT || 63500
}
...
function getMqttClient() {
    ...
    client = mqtt.connect(settings.mqtt.host, options);
    return client;
}
